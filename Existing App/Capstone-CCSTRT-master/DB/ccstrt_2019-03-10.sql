...
# Database: ccstrt
# Generation Time: 2019-03-10 18:03:44 +0000
# ************************************************************
...
# Dump of table tbl_racers
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tbl_racers`;
...
VALUES
	('ccstrt_admin','$2b$10$PfVV.2PTqYUxlygYJ.26puq4ec0ZaDyU0lNYE7nvi2mNEvOeZC8te','Admin',NULL);
